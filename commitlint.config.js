    ...
    questions: {
      type: {
        ...
        enum: {
          ...
          build: {
            description: 'Changes that affect the build system or external dependencies (example: make, cmake)',
            title: 'Builds',
            emoji: '🛠',
          },
          ci: {
      ...
      scope: {
        description: 'What is the scope of this change (e.g. core, api, contract)',
        enum: {
          core: {
          ...
          contract: {
            description: 'Contract library related',
          },
          solidcpp: {
            description: 'SolidCpp compiler code',
          },
          examples: {
